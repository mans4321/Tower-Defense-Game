...
public class WaveFactory {
    ...
    public WaveBuilder getWave(int waveNum) {
        switch (waveNum) {
            case 1:
                return new WaveBuilder(waveNum).critterA(1).critterB(2).critterC(3);
            case 2:
                return new WaveBuilder(waveNum).critterA(1).critterB(1).critterC(1);
            case 3:
                return new WaveBuilder(waveNum).critterA(3).critterB(10).critterC(8).critterD(8);
            case 4:
                return new WaveBuilder(waveNum).critterA(11).critterB(10).critterC(8).critterD(8);
            case 5:
