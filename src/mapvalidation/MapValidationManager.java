...
public class MapValidationManager {
    ...
    /**
     * Constructor method, will populate cols, rows, cellList and pathList
     * @param cellList map of tile types
     * @param mapCols map the number of columns selected for this map
     * @param mapRows map the number of rows selected for this map
     */
