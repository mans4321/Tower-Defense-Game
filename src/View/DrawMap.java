...
//    g.drawImage(new ImageIcon("res/tower1.png").getImage(),240,270,this);
    ...
    public static void drawCritters(Graphics g, int posX, int posY, ImageObserver observer){
        // TODO
        CritterA c = new CritterA(posX, posY);
        g.drawImage(c.getImage(),posX,posY,observer);
}
    public static void drawMissiles(Graphics g, Image img, int posX, int posY, ImageObserver observer){
